# Contributing to Z-Image Turbo Pro
...
### 🐛 Report Bugs
Found something broken? [Open an Issue](https://github.com/Shineii86/ZImagePro/issues) with:
...
### 💡 Suggest Features
Have an idea? [Start a Discussion](https://github.com/Shineii86/ZImagePro/issues) with:
...
2. **Clone** your fork: `git clone https://github.com/YOUR_USERNAME/ZImagePro.git`
